...
\begin{figure}[t]
    \centering
    \subfloat[Avg. frame rendering runtime (excluding first frame).]{\includegraphics[width=0.98\columnwidth]{plot_bench_frames.pdf}} \\
    \subfloat[First frame rendering runtime.]{\includegraphics[width=0.98\columnwidth]{plot_bench_first_frame.pdf}}
