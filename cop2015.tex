...
\CopyrightYear{2015}
\conferenceinfo{ECOOP}{'2015 Prague, Czech Republic}
...
\begin{tabular}{c|ccccc}
 & \specialcell{instance- \\ wide} & \specialcell{class- \\ wide} & \specialcell{instance \\ space overhead} & \specialcell{update header \\ runtime overhead\footnotemark} & \specialcell{composition change \\ runtime overhead} \\
\hline
...
When using instance-wide method inlining, an additional method object is stored per instance\footnotemark.
...
\begin{figure}[t]
    \subfloat[Average frame rendering runtime (excluding first frame).]{\includegraphics[width=\columnwidth]{plot_bench_frames.pdf}} \\
